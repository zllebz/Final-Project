    ...
    <div class="container">
        <div class="row">
            ...
            <div class="card border-0 shadow">
                ...
                <div class="col-md-12">
                        <label for="" class="form-label">สถานที่ที่เก็บข้อมูล</label>
                        <input type="text" class="js-example-basic-single col-md-12" name="numarea">
                    </div>
                    <div class="col-12">
                        <label for="provinces" class="form-label">เลือกจังหวัด</label>
                        <select name="provinces"   id="provinces" class=" js-example-basic-single col-md-12 ">
                    ...
                    <div class="col-12">
                        ...
                        <select name="amphures"   id="amphures" class=" js-example-basic-single col-md-12 ">
                            <option value="" selected disabled>-- กรุณาเลือก --</option>
                    ...
                    <div class="col-12">
                        ...
                        <select name="districts"   id="districts" class=" js-example-basic-single col-md-12 ">
                            <option value="" selected disabled>-- กรุณาเลือก --</option>
