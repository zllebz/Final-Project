...
<section class="content">
  ...
  <div class="card-header" style="background-color:#652D91">
      <h3 class="card-title"style="color:white">ตารางระบบจัดการเอกสารเรื่องการเก็บข้อมูลการใช้ประโยชน์ของพืชในท้องถิ่น</h3>
    </div>
    <br>
          ...
          <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
            <thead>
              ...
              <th tabindex="0" rowspan="1" colspan="1" style="width: 1%;">ลำดับ</th>
                ...
                <th tabindex="0" rowspan="1" colspan="1" style="width: 10%;">วัฒนธรรม</th>
              ...
              <?php while ($row = $result->fetch(PDO::FETCH_ASSOC)) { ?>
                ...
                <td><?php echo $number++; ?></td>
                  ...
                  <td><?php if($row["status"]== 0){
                    ...
                    ?>    
                  <td>
                  <a class="btn btn-info btn-xs" href="../edit_view/v_sheet_5.php?id=<?php echo $row["worksheet5_id"]; ?>">
                      <i class="fas fa-eye"></i>
                    </a>
                    <?php if ($_SESSION['position_id'] == 1) {
                      echo '<a class="btn btn-warning btn-xs" href="../edit_view/e_sheet_5.php?id=' . $row["worksheet5_id"] . '">' . '<i class="fas fa-pencil-alt"></i></a>';
                    } ?>
                  </td>
                </tr>
              <?php } ?>
