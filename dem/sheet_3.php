...
<section class="content">
  ...
  <div class="card-header" style="background-color:#652D91">
      <h3 class="card-title"style="color:white">ตารางระบบจัดการเอกสารเรื่องการเก็บข้อมูลด้านกายภาพในท้องถิ่น</h3>
    </div>
    <br>
                ...
                <td><?php echo $number++; ?></td>
                  ...
                  <td>
                    ...
                    <?php if ($_SESSION['position_id'] == 1) {
                      echo '<a class="btn btn-warning btn-xs" href="../edit_view/e_sheet_3.php?id=' . $row["worksheet3_id"] . '">' . '<i class="fas fa-pencil-alt"></i></a>';
                    } ?>
                  </td>
                </tr>
              <?php } ?>
